...
Команда фільтрації вказується як наступний аргумент після опції модуля, що закінчується на `--`. Наприклад, наступна команда викликає команду `tr` з аргументами `a-z A-Z` для відповідного слова у даних.

    greple -Mtee tr a-z A-Z -- '\w+' ...

Наведена вище команда перетворить усі знайдені слова з малих літер у великі. Насправді цей приклад не є корисним, оскільки **greple** може зробити те саме ефективніше за допомогою опції **--cm**.
...
Використовуючи опцію **--discrete**, для кожної частини, що зіставляється, викликається окрема команда. Ви можете помітити різницю, виконавши наступні команди.
...
Ви можете перекласти їх за допомогою сервісу DeepL, виконавши наведену вище команду з модулем **-Mtee**, викликавши команду **deepl** таким чином:
