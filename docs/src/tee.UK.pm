...
Команда фільтрації вказується як наступний аргумент після опції модуля, що закінчується на C<-->. Наприклад, наступна команда викликає команду C<tr> з аргументами C<a-z A-Z> для відповідного слова у даних.

    greple -Mtee tr a-z A-Z -- '\w+' ...

Наведена вище команда перетворить усі знайдені слова з малих літер у великі. Насправді цей приклад не є корисним, оскільки B<greple> може зробити те саме ефективніше за допомогою опції B<--cm>.
...
Використовуючи опцію B<--discrete>, для кожної частини, що зіставляється, викликається окрема команда. Ви можете помітити різницю, виконавши наступні команди.
...
Викликайте нову команду для кожної знайденої деталі.
...
Ви можете перекласти їх за допомогою сервісу DeepL, виконавши наведену вище команду з модулем B<-Mtee>, викликавши команду B<deepl> таким чином:
