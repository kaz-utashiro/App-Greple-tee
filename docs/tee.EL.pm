...
Η εντολή φίλτρου καθορίζεται ως τα ακόλουθα ορίσματα μετά την επιλογή της ενότητας που τελειώνει με C<-->. Για παράδειγμα, η επόμενη εντολή καλεί την εντολή C<tr> με ορίσματα C<a-z A-Z> για την αντιστοιχισμένη λέξη στα δεδομένα.

    greple -Mtee tr a-z A-Z -- '\w+' ...

Η παραπάνω εντολή μετατρέπει όλες τις αντιστοιχισμένες λέξεις από πεζά σε κεφαλαία. Στην πραγματικότητα αυτό το παράδειγμα δεν είναι χρήσιμο επειδή η εντολή B<greple> μπορεί να κάνει το ίδιο πράγμα πιο αποτελεσματικά με την επιλογή B<--cm>.
...
Χρησιμοποιώντας την επιλογή B<--discrete>, καλείται μεμονωμένη εντολή για κάθε αντιστοιχισμένο τμήμα. Μπορείτε να παρατηρήσετε τη διαφορά με τις ακόλουθες εντολές.
...
Μπορείτε να τα μεταφράσετε με την υπηρεσία DeepL εκτελώντας την παραπάνω εντολή με την ενότητα B<-Mtee> που καλεί την εντολή B<deepl> ως εξής:
